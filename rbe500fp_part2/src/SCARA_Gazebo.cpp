...
int main(int argc, char **argv)
{
    ...
    ros::ServiceClient IKclient = n.serviceClient<rbe500fp_part2::calcIK>("calculate_IK");
    ros::ServiceClient FKclient = n.serviceClient<rbe500fp_part2::calcFK>("calculate_FK");

    rbe500fp_part2::calcIK IKsrv;
    rbe500fp_part2::calcFK FKsrv;
